...
var NodeProp = class _NodeProp {
  ...
  static string() {
    return new _NodeProp({ deserialize: (str) => str });
  }
  /// Create a number-valued node prop whose deserialize function is
  /// just `Number`.
  static number() {
    return new _NodeProp({ deserialize: Number });
  }
  /// Creates a boolean-valued node prop whose deserialize function
  /// returns true for any input.
  static flag() {
    return new _NodeProp({ deserialize: () => true });
  }
...
var StringInput = class _StringInput {
  ...
  clip(at) {
    return new _StringInput(this.string, at);
  }
};
...
var Stack = class _Stack {
  ...
  static start(p, state, pos = 0) {
    ...
    return new _Stack(p, [], state, pos, pos, 0, [], 0, cx ? new StackContext(cx, cx.start) : null, null);
  }
  ...
  split() {
    ...
    return new _Stack(this.p, this.stack.slice(), this.state, this.reducePos, this.pos, this.score, buffer, base, this.curContext, parent);
  }
...
var StackBufferCursor = class _StackBufferCursor {
  ...
  static create(stack) {
    return new _StackBufferCursor(stack, stack.bufferBase + stack.buffer.length, stack.buffer.length);
  }
  maybeNext() {
...
var Parser = class _Parser {
  ...
  configure(config) {
    let copy = Object.assign(Object.create(_Parser.prototype), this);
    if (config.props)
